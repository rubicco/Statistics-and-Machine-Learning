...
% apply threshold in X matrix and get values as -1,1
% the result of paranthesis are 0 and 1 because of logical comparison
% after that *2-1 to get values as -1 and 1
C =  (P*X>P*T)*2 -1;
